...
import { Check, Shield, User, Trash2, Layout, Upload, RefreshCw, Key, CheckCircle2, AlertCircle, Globe, Sparkles, ExternalLink, Cpu, Image, Settings, ArrowLeft, Menu, X, Boxes } from "lucide-react";
...
export default function AdminSettingsPage(): React.ReactElement {
  ...
  const adminTabs = [
    ...
    { id: "blueprint", label: "Blueprint Extensions", icon: <Boxes size={20} /> },
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                  ...
                  <div className="flex-1 w-full text-center sm:text-left">
                    ...
                    <section id="features" className="scroll-mt-24 bg-card border border-border-subtle rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
                        <h2 className="text-xl font-bold mb-6 flex items-center text-foreground relative z-10">
...
<section id="runtime" className="scroll-mt-24 bg-card border border-border-subtle rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
                    ...
                    <section id="appearance" className="scroll-mt-24 bg-card/80 backdrop-blur-xl border border-border-subtle rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
                        <h2 className="text-xl font-bold mb-6 flex items-center text-foreground relative z-10">
